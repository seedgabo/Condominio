...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    @if($solvencia->estado == "Moroso")
      ...
      <li onclick='desactivar("{{$residencia->id}}","{{$mes}}","{{$año}}")'>
        <a style="color: grey;" href="#!"><i class="fa fa-eye-slash"></i> No Procesar este Cobro Aún</a>
      </li>
    @endif
