...
<div class="slider">
    <ul class="slides">
        <li class="">
            <img style="opacity: .5" src="{{url('images/condominio/slider1.jpg')}}">
        ...
        <li class="">
            <img style="opacity: .5" src="{{url('images/condominio/slider2.jpg')}}">
        ...
        <li class="">
            <img style="opacity: .5" src="{{url('images/condominio/slider3.jpg')}}">
...
<div class="row">
    ...
    <div class="col s12 m9 l9">
        <ul class="collapsible" data-collapsible="expandable">
            ...
            <li>
                <div class="collapsible-header center-align teal-text active">
                    <h5 style="text-transform: uppercase;">{{$noticia->titulo}}</h5>
                </div>
                <div class="collapsible-body row">
                    <div class="col s2 m2 ml2">
                        <img src="images/noticias/{{$noticia->media or '../favicon.png'}}" alt="" data-caption="{{$noticia->titulo}}" class="circle materialboxed" height="150">
                    </div>
