...
<script type="text/javascript">
    $(document).ready(function () {
        $('#table').jtable({
            ...
            actions: {
                listAction: "{{url('ajax/encuestas/list')}}",
                createAction: "{{url('ajax/encuestas/create')}}",
                updateAction: "{{url('ajax/encuestas/edit')}}",
                deleteAction: "{{url('ajax/encuestas/remove')}}",
            },
            fields: {
                id: {
                    title: 'ID',
                ...
                respuesta1:
                {
                    title: 'Respuesta Nro 1',
                    defaultValue: "Excelente"
                },
                 respuesta2:
                {
                    title: 'Respuesta Nro 2',
                    defaultValue: "Bueno"
                },
                 respuesta3:
                {
                    title: 'Respuesta Nro 3',
                    defaultValue: "Regular"
                },
                 respuesta4:
                {
                    title: 'Respuesta Nro 4',
                    defaultValue: "Malo"
                },
                 respuesta5:
                {
                    title: 'Respuesta Nro 5',
                    defaultValue: "Pésimo"
                },
                 respuesta6:
                {
                    title: 'Respuesta Nro 6',
                    defaultValue: "No lo sé"
                }
