        ...
        <nav>
            <div class="nav-wrapper  blue darken-3">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    @if (Auth::user()->admin)
                    <li class="tooltipped" data-delay="10" data-tooltip="Entrar Como Administrador"><a href="{{url('admin')}}" title="Entrar como Administrador">Admin</a></li>
                    @endif @endif
                </ul>
                ...
                <ul class="side-nav" id="mobile-demo">
                    ...
                    <li>
                        <a href="{{url('ver-encuestas')}}"> <i class="fa fa-list-alt left"></i>Encuestas</a>
                    </li>
                    <li><a href="{{url('directiva')}}"><i class="fa fa-info left"></i>Condominio</a></li>
                    <li>
                        <a href="{{url('ver-galeria')}}"> <i class="fa fa-picture-o left"></i>Galeria</a>
                    </li>
                    ...
                    <li><a href="{{url('Usuario-Edit')}}">Editar Informacion</a></li>
                    <li><a class="waves-effect waves-light btn modal-trigger" href="#solvencia">Revisar Solvencia</a></li>
                    @if (Auth::user()->admin)
            ...
            <table class="table highlight centered bordered">
                ...
                <tbody>                    @forelse ($residencias as $residencia)
                    <tr>
                        ...
                        <td class="green-text">Solvente</td>
                        @else
                        <td class="red-text">Moroso</td>
                        @endif
                    </tr>
            ...
            <div class="row">
                ...
                <div class="col l4 offset-l2 s12">
                    <ul>
                        ...
                        <li>
                            <a href="tel:+584144026566" class="grey-text text-lighten-3"> <i class="fa fa-phone"></i> Llamanos: 0414 402-6566</a>
                        </li>
                    </ul>
                </div>
            </div>
