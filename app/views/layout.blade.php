...
<head>
	...
	{{-- Link a FAVICON --}}
	<link rel="shortcut icon" href="{{ asset('favicon.ico') }}" type="image/x-icon" /> {{-- Librerias adicionales por plantillas hijas --}} 
	@yield('head', ' ') {{-- Estilo para Footer siempre debajo --}}
	<style type="text/css">
		body {
			display: flex;
			min-height: 100vh;
